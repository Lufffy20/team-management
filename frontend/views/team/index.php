...
<?php foreach($teams as $t): ?>
    <?php 
        ...
        $isManager = ($team->created_by == Yii::$app->user->id);

        $managerName = $isManager 
            ? "You" 
            : \common\models\User::findOne($team->created_by)->username;
    ?>
    ...
    <div class="col-md-4 col-lg-3">
        <div class="card border-0 shadow-sm p-3 hover-card" style="border-radius:14px;">
            ...
            <p class="text-muted small" style="min-height:35px;">
                <?= $team->description 
                    ? substr($team->description, 0, 40).'...' 
                    : 'No description available' ?>
            </p>

            <div class="d-flex justify-content-between small mb-2">
                <span>👥 Members: <b><?= $memberCount ?></b></span>
                <span>👤 Manager: <b><?= $managerName ?></b></span>
            </div>

            <div class="text-muted small">📅 Created: 
                <b><?= date('d M Y', $team->created_at) ?></b>
            </div>
            ...
            <div class="d-flex gap-2 mt-3">
                ...
                <?php if ($isManager): ?>
                    ...
                    <?= Html::a('Delete', ['/team/delete', 'id' => $team->id], [
